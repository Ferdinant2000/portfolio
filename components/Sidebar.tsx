"use client";
import { Facebook, Twitter, Instagram, Linkedin, Phone, Mail, MapPin, Calendar, User } from "lucide-react";
        ...
        <div className="w-80 p-6">
            ...
            >
                ...
                <div className="flex justify-center gap-4 mb-6">
                    {[
                        { icon: Facebook, bg: "bg-blue-600/80 hover:bg-blue-700/80" },
                        { icon: Twitter, bg: "bg-sky-500/80 hover:bg-sky-600/80" },
                        { icon: Instagram, bg: "bg-pink-500/80 hover:bg-pink-600/80" },
                        { icon: Linkedin, bg: "bg-blue-700/80 hover:bg-blue-800/80" },
                    ].map((social, i) => (
                        <div
                            key={i}
                            className={`w-10 h-10 ${social.bg} backdrop-blur-sm rounded-lg flex items-center justify-center cursor-pointer transition-colors`}
                        >
